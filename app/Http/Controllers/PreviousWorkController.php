...
class PreviousWorkController extends Controller
{
    public function index()
    {
        try {
            ...
            if ($previousWorks->isEmpty()) {
                return response()->json(['message' => 'No previousWorks found'], 404);
            }
       ...
       $validations =  Validator::make($request->all(), [
        ...
        try {
            if ($request->hasFile('image')) {
                ...
                return response()->json(['message' => 'Previous Work created successfully'], 201);
            } else {
    ...
    public function edit($id)
    {
        try {
            ...
            return response()->json(['message' => 'No previous work found with this ID'], 404);
        } catch (\Exception $e) {
