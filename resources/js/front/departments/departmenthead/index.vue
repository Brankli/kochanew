...
<template>
    <div v-for="departmenthead in departments.data " :key="departmenthead.id" class="font-roboto">
        ...
        <h1 class="font-bold text-4xl text-darkblue pt-8 capitalize text-center">department head</h1>
        <div class="grid md:grid-cols-3 sm:m-16">
            <div class="md:col-span-1 border-r-2 border-gray-200">
                <depProfile :name="departmenthead.name" :position="departmenthead.position" :mobile="departmenthead.phone_no" :email="departmenthead.email" :profile="departmenthead.profile" />
            </div>
            <div class="md:col-span-2">
                <div class="lg:flex  lg:flex-row gap-8 m-8">
                    <img src="asset/images/binocular.png" class="w-24 h-24  rounded-full" alt="">
                    <div>
                ...
                <div class="lg:flex  lg:flex-row gap-8 m-8">
                    <img src="asset/images/bulb.jpg" class="w-24 h-24 rounded-full" alt="">
                    <div>
                ...
                <div class="lg:flex  lg:flex-row gap-8 m-8">
                    <img src="asset/images/goal.png" class="w-24 h-24 rounded-full" alt="">
                    <div>
                ...
                <div class="mt-4">
                    ...
                    <div v-for="service in  services" :key="service.id">
                        <div v-if="service.department == 'department'" class="p-2 flex flex-row gap-3 hover:border-sky-100 hover:border-b w-full md:mt-0 hover:ml-4 mt-3 m-3 xl:p-0">
