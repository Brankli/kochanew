...
<template>
    <div v-for="departmenthead in departments.data " :key="departmenthead.id" class="font-roboto">
        <div v-if="departmenthead.position === 'development director'">
            <h1 class="font-bold text-4xl text-darkblue pt-8 capitalize text-center">Industry Development & Technoogy Group</h1>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="mt-4">
                        ...
                        <div v-for="service in  services" :key="service.id">
                            <div v-if="service.department == 'development'"
