...
<template>
    <name name="edit events and announcments" />
        ...
        <div class="border-2  bg-white border-gray-300 shadow-lg max-w-4xl mx-auto rounded shadow-gray-100">
            <div class="w-full  bg-white rounded-lg   md:mt-0 xl:p-0 ">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <h1 class="text-lg  text-sky-700 leading-tight tracking-wide">upload events and announcements use # for
                        new paragraph </h1>
                    <form class="mb-6">
                        <div class="mb-6">
                        ...
                        <div class="mb-6">
                            <label for="body" class="block mb-2 text-sm font-medium text-gray-900">write content
                                content</label>
