...
const newsponser = () => {
    ...
    axios.post(`./api/store/sponser`, formData).then(res => {
        ...
        window.location.href = "/admin#/sponsers"
    }).catch(res => {
        err.value = res.data;
    })
}
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="mb-6">
                        ...
                        <button @click.prevent="newsponser"
                            class="text-white bg-blue-700 hover:bg-blue-800 w-full focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 capitalize block">add partner</button>
                    </form>
                </div>
            </div>
        </div>
